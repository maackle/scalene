...
object vec2 {
  lazy val zero = mutable.zero
  lazy val one = mutable.one
//  lazy val Null = new immutable.vec2(-11111111111111, 11111111111111111111)
}

abstract class vec2base extends vector {
